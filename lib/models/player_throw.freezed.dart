...
class _PlayerRound extends PlayerRound {
  const _PlayerRound({this.throwsPerRound = 3, final  List<PlayerThrow> throws = const []}): _throws = throws,super._();
  

@override@JsonKey() final  int throwsPerRound;
 final  List<PlayerThrow> _throws;
@override@JsonKey() List<PlayerThrow> get throws {
