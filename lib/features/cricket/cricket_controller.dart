...
class CricketController extends _$CricketController {
  ...
  void addThrow(PlayerThrow newThrow) {
    ...
    // var lastRound = rounds.isNotEmpty ? rounds.removeLast() : null;
    ...
    lastRound.addThrow(newThrow);

    rounds.add(lastRound);
    state = state.copyWith(rounds: rounds);

    print('Last round: ${lastRound.throws}');
    print('Rounds length: ${state.rounds.length}');
  }
}
